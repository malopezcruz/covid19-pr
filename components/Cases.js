  ...
  return (
    <section className='mb-12 md:mb-24'>
      ...
      <div className='grid lg:grid-cols-2 lg:gap-2'>
        ...
        <article>
          <h3 className='text-base uppercase text-subtitle mb-4'>Semanal</h3>
          <BarPlot data={weekly_cases} caption='' />
        </article>

        <article>
          <h3 className='text-base uppercase text-subtitle mb-4'>14 días </h3>
          <BarPlot data={twoweeks_cases} caption='' />
        </article>

        <article>
          <h3 className='text-base uppercase text-subtitle mb-4'>Mensual</h3>
